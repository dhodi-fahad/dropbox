...
import { createUser, deleteUser, getUserById, getUsers, updateUser, User } from "../models/users.models";
...
export const createUserControler = (req: Request, res: Response): void => {
